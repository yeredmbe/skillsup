...
<header className="flex items-center justify-between border-b border-slate-200 px-6 py-3 bg-white z-10 shrink-0">
...
<aside className="w-full md:w-[380px] border-r border-slate-200 flex flex-col bg-white shrink-0">
<div className="p-4 border-b border-slate-100">
<div className="relative">
<span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-lg">search</span>
<input className="w-full bg-slate-50 border border-slate-200 rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-1 focus:ring-primary focus:border-primary outline-none" placeholder="Search conversations..." type="text"/>
</div>
</div>
...
<div className="flex items-center gap-4 p-4 border-b border-slate-50 hover:bg-slate-50 cursor-pointer transition-colors">
<div className="relative">
...
<div className="flex-1 min-w-0">
<div className="flex justify-between items-baseline">
<h3 className="font-semibold text-sm truncate text-slate-900">Sarah J. - Project Update</h3>
...
<div className="flex-1 min-w-0">
<div className="flex justify-between items-baseline">
<h3 className="font-semibold text-sm truncate text-slate-900">Marcus Chen</h3>
...
<div className="flex-1 min-w-0">
<div className="flex justify-between items-baseline">
<h3 className="font-semibold text-sm truncate text-slate-900">Elena Rodriguez</h3>
...
<div className="flex-1 min-w-0">
<div className="flex justify-between items-baseline">
<h3 className="font-semibold text-sm truncate text-slate-900">David Kim</h3>
...
<div>
<h2 className="font-bold text-base text-slate-900 leading-none">Prof. Aris - Python Basics</h2>
...
<span className="text-[10px] font-bold uppercase tracking-wider text-slate-400 bg-white px-3 py-1 rounded-full border border-slate-100 shadow-sm">Today</span>
</div>
...
<p className="text-sm text-slate-800 leading-relaxed">Hello! I've just reviewed the curriculum for module 4. Have you had a chance to look at the Python Basics assessment yet?</p>
</div>
...
<div className="flex flex-col gap-1">
<div className="bg-white border border-slate-200 px-4 py-3 rounded-xl rounded-tl-none shadow-sm">
<p className="text-sm text-slate-800 leading-relaxed">The skill assessment is ready for review. I've added some notes to the specific lines you might find tricky.</p>
</div>
...
<textarea className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-primary focus:border-primary outline-none resize-none max-h-32" placeholder="Type your message..." rows="1"></textarea>
</div>
