...
export const Verification = () => {
    return (
        <React.Fragment>
            ...
            <header className="w-full bg-white dark:bg-black border-b border-slate-200 dark:border-slate-800 sticky top-0 z-50">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="h-8 w-8 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden">
                                <img alt="Profile" className="w-full h-full object-cover" data-alt="Professional headshot of a smiling male teacher" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBSCJKn9p7d1Ns1I7pxoti2HFICzB439hZzGjPL2ZJgZpMQwH6Ks6UCZBDqd1KmLW7b6_jykRcxhGOmsOgzan1mwByf7Fet4d-LBCxpd-4axt-V3krYvJCaeSVZRPPpTg55pL2GEnRNeG7AgqohwXUGdELUve6e8f5quLz_Uc-eCg9SLRHmYyjKevLXfiU-b4h4lpBBJX0lIorv-xALLQl404ykvugUqSGjG5T0YFRCBXLOAkJIkHHTvN1s-NSiyOZJgFnkjz51RQ" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <main className="flex-1 flex flex-col items-center">
                ...
                <div className="w-full bg-white dark:bg-black border-b border-slate-200 dark:border-slate-800 py-6">
                    <div className="max-w-4xl mx-auto px-4">
                        <div className="flex justify-between items-end mb-3">
                            <div>
                                <span className="text-xs font-bold uppercase tracking-widest text-primary/60 dark:text-white/60">Final Step</span>
                                <h2 className="text-2xl font-black text-slate-900 dark:text-white">Stage 2 of 2: Verification</h2>
                            </div>
                            <span className="text-sm font-bold text-primary dark:text-white bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-full">90% Complete</span>
                        </div>
                        <div className="w-full h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                            <div className="h-full bg-primary dark:bg-white w-[90%] rounded-full transition-all duration-1000"></div>
                        </div>
                        <p className="mt-4 text-slate-500 dark:text-slate-400 text-sm">Almost there! Complete your registration fee to unlock student inquiries.</p>
                    </div>
                </div>

                <div className="max-w-6xl w-full mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-5 space-y-10">
                        ...
                        <div className="pt-8 border-t border-slate-200 dark:border-slate-800">
                            ...
                            <p className="mt-4 text-xs text-slate-500">Your payment information is processed securely. We do not store your private mobile money credentials.</p>
                        </div>
                    </div>
                        ...
                        <div className="bg-white dark:bg-black rounded-xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
                            ...
                            <div className="p-8 space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <label className="relative flex flex-col items-center justify-center p-4 border-2 border-primary rounded-xl cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-900 transition-all bg-slate-50 dark:bg-slate-900">
                                            <input checked="" className="sr-only" name="provider" type="radio" value="mtn" />
                                ...
                                <p className="text-center text-xs text-slate-400 mt-6">
                                    By clicking "Initiate Payment", you agree to SkillsUp's Terms of Service and Privacy Policy. All fees are non-refundable.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <footer className="mt-auto border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-black py-8">
                <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-2 opacity-60">
                        <span className="material-symbols-outlined text-sm">copyright</span>
                        <span className="text-sm font-medium">{new Date().getFullYear()} SkillsUp Platform. All rights reserved.</span>
                    </div>
                    <div className="flex gap-8">
                        <a className="text-xs font-bold text-slate-500 hover:text-primary uppercase tracking-widest" href="#">Privacy Policy</a>
                        <a className="text-xs font-bold text-slate-500 hover:text-primary uppercase tracking-widest" href="#">Terms of Service</a>
                        <a className="text-xs font-bold text-slate-500 hover:text-primary uppercase tracking-widest" href="#">Contact Support</a>
                    </div>
                </div>
            </footer>
