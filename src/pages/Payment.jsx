...
<nav className="flex justify-between items-center px-6 h-16 w-full border-b border-gray-100 bg-white font-sans antialiased">
<div className="text-xl font-bold tracking-tighter text-black">SkillsUp</div>
<div className="flex items-center gap-4">
<span className="material-symbols-outlined text-black cursor-pointer hover:opacity-70 transition-opacity">account_circle</span>
</div>
</nav>
...
<div className="bg-zinc-50 border border-gray-100 rounded-xl p-8 mb-10 text-left">
...
<button className="w-full bg-black text-white font-bold py-4 rounded-lg hover:opacity-90 transition-all active:scale-[0.98] mb-6">
                Go to Dashboard
            </button>

<a className="inline-flex items-center gap-2 text-sm font-bold text-black border-b-2 border-black pb-0.5 hover:opacity-70 transition-opacity" href="#">
...
<div className="absolute top-1/4 -right-20 w-96 h-96 bg-zinc-100 rounded-full blur-3xl"></div>
<div className="absolute bottom-1/4 -left-20 w-96 h-96 bg-zinc-100 rounded-full blur-3xl"></div>
</div>
</main>
