...
<header className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-black px-6 py-3">
...
<input className="w-full pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-900 border-none rounded-lg focus:ring-2 focus:ring-primary text-sm" placeholder="Search for subjects or teachers..." type="text"/>
</div>
</div>
</div>
<nav className="hidden lg:flex items-center gap-8">
<a className="text-sm font-medium hover:text-primary/70 transition-colors" href="#">Find Teachers</a>
<a className="text-sm font-medium hover:text-primary/70 transition-colors" href="#">My Lessons</a>
<a className="text-sm font-medium hover:text-primary/70 transition-colors" href="#">Messages</a>
</nav>
<div className="flex items-center gap-3">
<button className="px-4 py-2 text-sm font-bold bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 transition-colors">Login</button>
<button className="px-4 py-2 text-sm font-bold bg-primary text-white dark:bg-white dark:text-black rounded-lg hover:opacity-90 transition-opacity">Sign Up</button>
</div>
</div>
</header>
...
<div className="px-2">
<div className="h-1 w-full bg-slate-200 dark:bg-slate-700 rounded-full relative">
<div className="absolute h-1 bg-primary left-1/4 right-1/4"></div>
<div className="absolute w-4 h-4 bg-primary border-2 border-white dark:border-black rounded-full -top-1.5 left-1/4 cursor-pointer"></div>
<div className="absolute w-4 h-4 bg-primary border-2 border-white dark:border-black rounded-full -top-1.5 right-1/4 cursor-pointer"></div>
</div>
...
<div className="border-t border-slate-200 dark:border-slate-800 pt-6 mt-6 space-y-3">
...
<select className="w-full pl-9 pr-4 py-2 text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg appearance-none focus:ring-primary focus:border-primary">
...
<div className="space-y-2">
<button className="flex items-center gap-2 w-full px-3 py-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-sm font-medium">
<span className="material-symbols-outlined text-yellow-500 fill-icon">star</span>
<span>4.5 &amp; up</span>
</button>
<button className="flex items-center gap-2 w-full px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors">
<span className="material-symbols-outlined text-yellow-500 fill-icon">star</span>
<span>4.0 &amp; up</span>
</button>
</div>
</div>
<button className="w-full mt-8 py-3 text-sm font-bold text-primary dark:text-white border-2 border-primary dark:border-white rounded-lg hover:bg-primary hover:text-white dark:hover:bg-white dark:hover:text-black transition-all">
                    Clear All Filters
                </button>
</div>
</aside>
...
<div className="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden hover:shadow-xl hover:border-primary transition-all duration-300">
...
<div className="absolute top-3 right-3 bg-white/90 dark:bg-black/90 px-2 py-1 rounded-lg flex items-center gap-1 shadow-sm">
...
<span className="text-primary dark:text-white font-black text-xl">$120<span className="text-xs font-normal text-slate-500">/mo</span></span>
</div>
<p className="text-xs font-medium text-primary/60 dark:text-white/60 mb-3 uppercase tracking-wider">Senior Product Designer</p>
<p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-3 mb-auto">
...
<button className="w-full mt-4 py-2.5 bg-primary text-white dark:bg-white dark:text-black rounded-lg font-bold text-sm hover:opacity-90 transition-opacity">
                            View Profile
                        </button>
</div>
</div>
...
<span className="text-primary dark:text-white font-black text-xl">$85<span className="text-xs font-normal text-slate-500">/mo</span></span>
</div>
<p className="text-xs font-medium text-primary/60 dark:text-white/60 mb-3 uppercase tracking-wider">Visual Designer &amp; Artist</p>
<p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-3 mb-auto">
...
<span className="text-primary dark:text-white font-black text-xl">$200<span className="text-xs font-normal text-slate-500">/mo</span></span>
</div>
<p className="text-xs font-medium text-primary/60 dark:text-white/60 mb-3 uppercase tracking-wider">Design Researcher</p>
<p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-3 mb-auto">
...
<span className="text-primary dark:text-white font-black text-xl">$95<span className="text-xs font-normal text-slate-500">/mo</span></span>
</div>
<p className="text-xs font-medium text-primary/60 dark:text-white/60 mb-3 uppercase tracking-wider">Full Stack Designer</p>
<p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-3 mb-auto">
...
<span className="text-primary dark:text-white font-black text-xl">$150<span className="text-xs font-normal text-slate-500">/mo</span></span>
</div>
<p className="text-xs font-medium text-primary/60 dark:text-white/60 mb-3 uppercase tracking-wider">UI Specialist</p>
<p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-3 mb-auto">
...
<span className="text-primary dark:text-white font-black text-xl">$110<span className="text-xs font-normal text-slate-500">/mo</span></span>
</div>
<p className="text-xs font-medium text-primary/60 dark:text-white/60 mb-3 uppercase tracking-wider">UX Strategist</p>
<p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-3 mb-auto">
...
<button className="w-10 h-10 flex items-center justify-center rounded-lg bg-primary text-white dark:bg-white dark:text-black font-bold">1</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">2</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">3</button>
<span className="px-2">...</span>
<button className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">12</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
<span className="material-symbols-outlined">chevron_right</span>
</button>
</div>
<div className="mt-12 text-center">
<button className="px-8 py-3 bg-primary text-white dark:bg-white dark:text-black font-bold rounded-lg hover:opacity-90 transition-opacity">
                    Load More Teachers
                </button>
</div>
</section>
</main>
<footer className="mt-20 border-t border-slate-200 dark:border-slate-800 py-12 bg-white dark:bg-black">
...
<div className="text-sm text-slate-400">
                © 2024 SkillsUp Marketplace. All rights reserved.
            </div>
</div>
</footer>
