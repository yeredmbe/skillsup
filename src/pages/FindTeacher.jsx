        ...
        <React.Fragment>
            ...
            <header className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-black px-6 py-3">
                <div className="max-w-[1440px] mx-auto flex items-center justify-between gap-8">
                    ...
                    {false && <div className="h-8 w-8 rounded-full bg-slate-200 overflow-hidden border border-slate-300 dark:border-slate-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <div className="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden hover:shadow-xl hover:border-primary transition-all duration-300">
                            ...
                            <div className="p-5 flex flex-col h-[240px]">
                                ...
                                <Link to="/profile/1" className="w-full text-center mt-4 py-2.5 bg-primary text-white dark:bg-white dark:text-black rounded-lg font-bold text-sm hover:opacity-90 transition-opacity">
                                    View Profile
                                </Link >
                            </div>
                        </div>
