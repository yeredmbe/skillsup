...
<a className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-slate-100 rounded-lg transition-all" href="/teachers">
...
<a className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-slate-100 rounded-lg transition-all" href="/messages">
...
<a className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-slate-100 rounded-lg transition-all" href="/settings">
<span className="material-symbols-outlined">settings</span>
<span className="font-medium">Settings</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-slate-100 rounded-lg transition-all" href="/landing">
...
<input className="w-full bg-slate-100 border-none rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-1 focus:ring-primary transition-all" placeholder="Search for tutors, subjects, or notes..." type="text"/>
</div>
</div>
...
<div className="bg-white p-5 rounded-xl border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center gap-5 hover:border-primary transition-all group">
...
<div className="flex items-center gap-2 px-3 py-1 bg-slate-100 rounded text-sm font-semibold">
<span className="material-symbols-outlined text-xs">calendar_month</span>
                                        Today, Oct 24
                                    </div>
<div className="flex items-center gap-2 px-3 py-1 bg-primary/10 text-primary rounded text-sm font-bold">
...
<div className="bg-white p-5 rounded-xl border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center gap-5 hover:border-primary transition-all">
<div className="size-16 rounded-lg bg-slate-100 overflow-hidden">
...
<button className="sm:ml-4 p-2 rounded-lg border border-slate-200 text-slate-400">
<span className="material-symbols-outlined">arrow_forward</span>
</button>
</div>
</div>
...
<a className="text-sm font-bold text-primary hover:underline" href="#">Browse tutors</a>
</div>
...
<button className="w-full py-2 text-sm font-bold text-slate-500 hover:text-primary transition-colors">Clear all activity</button>
</div>
</div>
...
<p className="text-primary/70 text-sm mt-1">4 of 10 hours completed</p>
