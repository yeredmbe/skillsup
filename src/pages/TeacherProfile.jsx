                ...
                <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="hidden md:flex relative group">
                            ...
                            <input className="pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-full w-64 focus:ring-2 focus:ring-primary text-sm" placeholder="Search for tutors..." type="text" />
                        </div>
                    </div>
                ...
                <div className="bg-white dark:bg- shadow-sm overflow-hidden md:rounded-b-xl border-x border-b border-slate-200 dark:border-slate-800">
                    ...
                    <div className="relative h-48 md:h-80 w-full bg-slate-200">
                        ...
                        <div className="absolute bottom-4 right-4">
                            <button className="flex items-center gap-2 bg-white/90 dark:bg-black/50 backdrop-blur px-4 py-2 rounded-lg text-sm font-semibold border border-white/20">
                    ...
                    <div className="px-4 md:px-8 pb-6">
                        <div className="relative flex flex-col md:flex-row items-end md:items-center gap-4 -mt-12 md:-mt-16 mb-4">
                            ...
                            <div className="flex-1 text-center md:text-left pt-2 md:pt-14">
                                <div className="flex items-center justify-center md:justify-start gap-2">
                                    ...
                                    <span className="material-symbols-outlined text-primary dark:text-white fill-1" title="Verified Expert">verified</span>
                                </div>
                                <p className="text-slate-500 dark:text-slate-400 font-medium">Senior Mathematics &amp; Physics Instructor</p>
                            ...
                            <div className="flex gap-2 w-full md:w-auto pt-4 md:pt-14">
                                ...
                                <button className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white px-6 py-2.5 rounded-lg font-bold text-sm hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                        ...
                        <div className="border-t border-slate-100 dark:border-slate-800 mt-6 pt-4">
                            <nav className="flex gap-6 overflow-x-auto no-scrollbar">
                                <a className="pb-4 border-b-2 border-primary dark:border-white font-bold text-sm whitespace-nowrap" href="#">About</a>
                                <a className="pb-4 border-b-2 border-transparent text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 font-bold text-sm whitespace-nowrap" href="#">Reviews</a>
                                <a className="pb-4 border-b-2 border-transparent text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 font-bold text-sm whitespace-nowrap" href="#">Resources</a>
                                <a className="pb-4 border-b-2 border-transparent text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 font-bold text-sm whitespace-nowrap" href="#">Portfolio</a>
                            </nav>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mt-6 px-4 md:px-0">
                    ...
                    <div className="md:col-span-4 space-y-6">
                        ...
                        <div className="bg-white dark:bg- p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                            ...
                            <div className="relative group cursor-pointer aspect-video rounded-lg overflow-hidden bg-slate-100 border border-slate-200 dark:border-slate-700">
                                ...
                                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors flex items-center justify-center">
                                    <div className="h-16 w-16 rounded-full bg-white/90 dark:bg-black/60 flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform">
                                        <span className="material-symbols-outlined text-4xl text-primary dark:text-white fill-1">play_arrow</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xl font-black text-primary dark:text-white">$450.00</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                        ...
                        <div className="bg-white dark:bg- p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-full text-xs font-bold uppercase">Quantum Mechanics</span>
                                <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-full text-xs font-bold uppercase">Algebra II</span>
                                <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-full text-xs font-bold uppercase">Thermodynamics</span>
                                <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-full text-xs font-bold uppercase">SAT Prep</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-8 space-y-6">
                        ...
                        <div className="bg-white dark:bg- p-6 md:p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="flex gap-4">
                                    <div className="h-10 w-10 shrink-0 bg-primary/10 dark:bg-white/10 rounded-lg flex items-center justify-center">
                                        <span className="material-symbols-outlined text-primary dark:text-white">visibility</span>
                                    </div>
                                    <div>
                                ...
                                <div className="flex gap-4">
                                    <div className="h-10 w-10 shrink-0 bg-primary/10 dark:bg-white/10 rounded-lg flex items-center justify-center">
                                        <span className="material-symbols-outlined text-primary dark:text-white">model_training</span>
                                    </div>
                                    <div>
                                ...
                                <div className="flex gap-4">
                                    <div className="h-10 w-10 shrink-0 bg-primary/10 dark:bg-white/10 rounded-lg flex items-center justify-center">
                                        <span className="material-symbols-outlined text-primary dark:text-white">update</span>
                                    </div>
                                    <div>
                                ...
                                <div className="flex gap-4">
                                    <div className="h-10 w-10 shrink-0 bg-primary/10 dark:bg-white/10 rounded-lg flex items-center justify-center">
                                        <span className="material-symbols-outlined text-primary dark:text-white">edit_note</span>
                                    </div>
                                    <div>
                        ...
                        <div className="bg-white dark:bg- p-6 md:p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                            ...
                            <div className="w-full h-64 bg-slate-100 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700">
                            ...
                            <div className="mt-4 flex items-center justify-between">
                                ...
                                <button className="text-primary dark:text-white text-sm font-bold flex items-center gap-1">
