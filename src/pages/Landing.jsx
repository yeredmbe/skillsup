...
<h1 className="text-xl font-extrabold tracking-tighter text-primary uppercase">SkillsUp</h1>
</div>
<div className="hidden md:flex items-center gap-10">
<a className="text-sm font-semibold hover:text-primary/70 transition-colors" href="#">Find a Teacher</a>
<a className="text-sm font-semibold hover:text-primary/70 transition-colors" href="#">Become a Tutor</a>
<a className="text-sm font-semibold hover:text-primary/70 transition-colors" href="#">How it Works</a>
</div>
<div className="flex items-center gap-4">
<button className="text-sm font-bold px-4 py-2 hover:bg-slate-50 rounded-lg transition-colors">Log In</button>
<button className="bg-primary text-white text-sm font-bold px-6 py-2.5 rounded-lg hover:bg-primary/90 transition-all shadow-sm">Sign Up</button>
</div>
</div>
</nav>
...
<p className="text-slate-500 leading-relaxed">Browse thousands of verified tutors by subject, experience, and proximity to your home.</p>
</div>
...
<h3 className="text-xl font-bold mb-3">Book a Free Trial</h3>
<p className="text-slate-500 leading-relaxed">Schedule a 30-minute introductory session to discuss goals and ensure it's the right fit.</p>
</div>
...
<p className="text-slate-500 leading-relaxed">Begin your personalized lesson plan from the comfort of your own living room.</p>
</div>
</div>
</div>
</section>
...
<button className="w-full py-3 bg-slate-100 group-hover:bg-primary group-hover:text-white rounded-xl text-sm font-bold transition-colors mt-2">View Profile</button>
</div>
</div>
...
<button className="w-full sm:w-auto px-10 py-4 border border-white/20 font-bold rounded-xl hover:bg-white/10 transition-colors">Become a Tutor</button>
</div>
</div>
</section>
...
<p className="text-xs text-slate-400">© 2024 SkillsUp Tutoring Ltd. All rights reserved.</p>
